    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-file-alt mr-2"></i>Tambah Jenis Surat
            </h2>
            <div>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6 pb-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-800">
                            <i class="fas fa-plus-circle mr-2 text-blue-600"></i>Form Tambah Jenis Surat
                        </h3>
                        <p class="text-sm text-gray-600 mt-1">Isi form berikut untuk menambahkan jenis surat baru ke sistem.</p>
                    </div>

                    <!-- Form -->
                    <form action="{{ route('admin.jenis_surat.store') }}" method="POST" id="jenisSuratForm">
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('deskripsi') border-red-300 @enderror" 
                                          ...
                                          name="deskripsi" 
                                          rows="3" 
                                          placeholder="Deskripsi jenis surat...">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('template') border-red-300 @enderror" 
                                        id="template" 
                                        name="template">
                                    <option value="default" selected>Default Template</option>
                                    <option value="sktm">Template SKTM</option>
                                    <option value="domisili">Template Domisili</option>
                                    <option value="usaha">Template Usaha</option>
                                </select>
                                @error('template')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <p class="mt-1 text-xs text-gray-500">Template surat akan digunakan untuk generate PDF</p>
                            </div>
